...
namespace Application.WCF.Server.Repositories.Standard
{
    public class ProductRepository : ServiceRepository<Product>
    {
        ...
        public ProductRepository(ApplicationEntities dbContext, string relatedObjects = "ProductFeatures")
        ...
        public override int ListTotal(SearchInput searchInput)
        {
            return base.ListTotal(searchInput);
        }
