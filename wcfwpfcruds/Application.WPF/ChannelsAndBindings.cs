...
namespace ApplicationWPF
{
    ...
    public class ChannelsAndBindings<T> where T : class
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetServiceAddress(string protocol, string ip, string port, string relativeAddress)
        {
            return string.Format("{0}://{1}:{2}/{3}", protocol, ip, port, relativeAddress);
        }
        #endregion
