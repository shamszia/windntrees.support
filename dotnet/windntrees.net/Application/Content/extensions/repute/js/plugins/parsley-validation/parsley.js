    ...
    _bindFields: function () {
      ...
      this.$element.find(this.options.inputs).each(function () {
        ...
        if (('ParsleyField' === fieldInstance.__class__ || 'ParsleyFieldMultiple' === fieldInstance.__class__) && !fieldInstance.$element.is(fieldInstance.options.excluded))
          if ('undefined' === typeof instance.fieldsMappedById[fieldInstance.__class__ + '-' + fieldInstance.__id__]) {
            instance.fieldsMappedById[fieldInstance.__class__ + '-' + fieldInstance.__id__] = fieldInstance;
            instance.fields.push(fieldInstance);
          }
      });
      return this;
    }
