...
namespace Controls.Navs
{
    public class NavigationComposer
    {
        ...
        public static MvcHtmlString composePathNavigation(String path, String cssClass = "breadcrumb", string listItemCssClass = "breadcrumb-item", String version = "4.0")
        {
            ...
            return new MvcHtmlString(pathList);
        }

        public static MvcHtmlString composeFromJson(String[] navigations, String authorizedUser, String[] authorizedRoles, String[] renderingRoles, String requestedAddress,
