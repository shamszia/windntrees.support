...
namespace Controls.Grid
{
    ...
    public class GridComposer
    {
        ...
        /// <returns></returns>
        public static MvcHtmlString composeBasicViews(string formId, bool modalForm = true, string newDialogAttributes = null, string editDialogAttributes = null)
        {
            ...
            string basicViews = "<section> " +
                                    ...
                                    "                <button " + newFormAttributes + " title='" + SharedLibrary.Resources.Global.FormMessages.NewD + "'><span>" + SharedLibrary.Resources.Global.FormMessages.New + "</span></button> " +
                                    "            </span> " +
                                    ...
                                    "    <tr> " +
                                    "        <th class='col-5'> " +
                                    "            <span title='" + SharedLibrary.Resources.Global.FormMessages.FieldNameD + "'> " + SharedLibrary.Resources.Global.FormMessages.FieldName + " </span> " +
                                    "        </th> " +
                                    "        <th class='col-5'> " +
                                    "            <span title='" + SharedLibrary.Resources.Global.FormMessages.FieldDescriptionD + "'> " + SharedLibrary.Resources.Global.FormMessages.FieldDescription + " </span> " +
                                    "        </th> " +
                                    "        <th class='col-2'>&nbsp;</th> " +
                                    "    </tr> " +
                                    "</script> " +
                                    ...
                                    "                <a class='green' href='#' " + editFormAttributes + " title='" + SharedLibrary.Resources.Global.FormMessages.EditD + "'><i class='fa fa-edit text-success'></i><span>" + SharedLibrary.Resources.Global.FormMessages.Edit + "</span></a><br /> " +
                                    "                <a class='red' href='#' data-bind='click: function(data, event) { $parent.delete($data); }' title='" + SharedLibrary.Resources.Global.FormMessages.DeleteD + "'><i class='fa fa-times text-danger'></i><span>" + SharedLibrary.Resources.Global.FormMessages.Delete + "</span></a> " +
                                    "            </div> " +
                                    "        </td> " +
                                    "    </tr> " +
                                    "</script> " +
                                    ...
                                    "            <span class='input-group-addon'><span>" + SharedLibrary.Resources.Global.FormMessages.ListSize + "</span></span> " +
                                    ...
                                    "                <li class='input-group-addon' data-bind='css: {disabled: CurrentList() == 1}'><a href = '#' data-bind='click: function(){ if (CurrentList() > 1) {find(CurrentList() - 1); } }'><span>" + SharedLibrary.Resources.Global.FormMessages.PrevPage + "</span></a></li> " +
                                    ...
                                    "                <li class='input-group-addon' data-bind='css: {disabled: CurrentList() == ListNavigator().calculateTotalPages()}'><a href = '#' data-bind='click: function(){ if (CurrentList() <ListNavigator().calculateTotalPages()) {find(CurrentList() + 1); } }'><span>" + SharedLibrary.Resources.Global.FormMessages.NextPage + "</span></a></li> " +
                                    "            </ul> " +
                                    "        </div> " +
                                    "    </div> " +
                                    "</script> " +
                                    ...
                                    "        <div class='input-group'> " +
                                    "            <ul class='gridlist' data-bind='if: ListNavigator().calculateTotalPages() > 1'> " +
                                    "                <li class='input-group-addon' data-bind='css: {disabled: CurrentList() == 1}'><a href = '#' data-bind=\"click: function(){ if (CurrentList() > 1) { selectDetail({'record': $parents[0].getContextualMasterKeyRecord(), 'page': CurrentList() - 1, 'navigation': true}); }}\"><span>" + SharedLibrary.Resources.Global.FormMessages.PrevPage + "</span></a></li> " +
                                    ...
                                    "                <li class='input-group-addon' data-bind='css: {disabled: CurrentList() == ListNavigator().calculateTotalPages()}'><a href = '#' data-bind=\"click: function(){ if (CurrentList() <ListNavigator().calculateTotalPages()) { selectDetail({'record': $parents[0].getContextualMasterKeyRecord(), 'page': CurrentList() + 1, 'navigation': true}); }}\"><span>" + SharedLibrary.Resources.Global.FormMessages.NextPage + "</span></a></li> " +
                                    "            </ul> " +
                                    "        </div> " +
                                    "    </div> " +
                                    "</script> " +
        ...
        /// <summary>
        /// Composes grid related detail HTML content submission widgets or controls.
        /// </summary>
        /// <param name="formId">This is form id that is integrated within content.</param>
        /// <returns></returns>
        public static MvcHtmlString composeDetailActions(string formId)
        {
            string detailActions = "<section> " +
                                    ...
                                    "            </span> " +
                                    "            <span class='input-group-btn' data-bind='visible: $parents[0].getContextualMasterKeyRecord() !== null'> " +
                                    "                <button data-bind=\"click: function() { resetDetailForm({ '_relatedrecordtype': 'level1-record-id', '_relatedrecordid': $parents[0].getContextualMasterKeyRecord().getKey() }); }\" class='btn btn-default' data-toggle='modal' data-target='" + formId + "' title='" + SharedLibrary.Resources.Global.FormMessages.FieldNewDetailD + "'><span> " + SharedLibrary.Resources.Global.FormMessages.FieldNewDetail + " </span></button> " +
                                    "            </span> " +
                                    "            <input class='form-control' data-bind='value: Keyword' type='text' placeholder='" + SharedLibrary.Resources.Global.FormMessages.Keyword + "' /> " +
                                    "            <span class='input-group-btn' data-bind='visible: $parents[0].getContextualMasterKeyRecord() === null'> " +
                                    "                <button data-bind='click: function() { find(1); }' class='btn btn-default' type='button' title='" + SharedLibrary.Resources.Global.FormMessages.SearchD + "'><span>" + SharedLibrary.Resources.Global.FormMessages.Search + "</span></button> " +
                                    "            </span> " +
                                    "            <span class='input-group-btn' data-bind='visible: $parents[0].getContextualMasterKeyRecord() !== null'> " +
                                    "                <button data-bind='click: function() { findDetail(1); }' class='btn btn-default' type='button' title='" + SharedLibrary.Resources.Global.FormMessages.SearchD + "'><span>" + SharedLibrary.Resources.Global.FormMessages.Search + "</span></button> " +
                                    "            </span> " +
                                    "        </div> " +
                                    "    </div> " +
                                    "    <br /> " +
            ...
            return new MvcHtmlString(detailActions);
        }
        ...
        /// <param name="formId">This is form id that is integrated within content.</param>
        /// <returns></returns>
        public static MvcHtmlString composeDetailListing(string formId)
        {
            ...
            return new MvcHtmlString(detailListing);
        }
        ...
        /// <returns></returns>
        public static MvcHtmlString composeGrid(string gridId, string cssClass, string gridClass, string title, string formTitle, string actions, string headings, string rows, string summary, string listing, string messages = null, string status = null)
        {
