...
namespace ApplicationForms.Core.Score
{
    public partial class FormScoreCRUD2CRUDCB : Form
    {
        ...
        ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository percentage90Repository = null;
        ...
        private ServiceClient<Application.Models.Standard.DataAccess.Score> ScoreServiceClient100_90
        {
            get
            {
                ...
                {
                    percentage90Repository = new ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository(90);
        ...
        ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository percentage80Repository = null;
        ...
        private ServiceClient<Application.Models.Standard.DataAccess.Score> ScoreServiceClient90_80
        {
            get
            {
                ...
                {
                    percentage80Repository = new ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository(80);
        ...
        ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository percentage70Repository = null;
        ...
        private ServiceClient<Application.Models.Standard.DataAccess.Score> ScoreServiceClient80_70
        {
            get
            {
                ...
                {
                    percentage70Repository = new ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository(70);
        ...
        ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository percentage60Repository = null;
        ...
        private ServiceClient<Application.Models.Standard.DataAccess.Score> ScoreServiceClient70_60
        {
            get
            {
                ...
                {
                    percentage60Repository = new ApplicationForms.Core.CBModelRepository.PercentageClientCBRepository(60);
