...
namespace ApplicationForms.Core.Product
{
    ...
    public partial class FormProduct : Form
    {
        ...
        public FormProduct(string title, EntityPersistanceState entityPersistanceState = EntityPersistanceState.Create, string language = null)
        {
            if (language != null)
            {
        ...
        {
            bindingSourceEntity.DataSource = new Application.Models.Standard.DataAccess.Product();
        }
