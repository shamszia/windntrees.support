...
namespace Application.WCF.Server.Repositories
{
    ...
    public class ScoreRepository : ServiceCBRepository<Score>
    {
        ...
        #region CRUDL
        //Understood (Wellknown) intent communication methods. 
        ...
        /// <summary>
        /// Subscribes for callback channel and report repository using OnServiceCallback event.
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// UnSubscribes callback channel and report using OnServiceCallback event.
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
